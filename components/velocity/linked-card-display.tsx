            ...
            <div className="relative bg-gradient-to-br from-white/5 to-white/0 backdrop-blur-sm border border-white/10 rounded-xl p-4">
                            ...
                            >
                                <div className="flex items-start gap-1.5">
                                    <div className="flex-shrink-0 mt-0.5">
                                        <div className={`w-1.5 h-1.5 rounded-full ${benefit.maxAmount ? 'bg-current animate-pulse' : 'bg-current/50'
                                            }`}></div>
                                    </div>
                                    <div className="flex-1 min-w-0">
                                        <p className="text-xs font-bold truncate">{benefit.benefitName}</p>
                                        <div className="flex items-center gap-1 mt-0.5 text-[10px] opacity-75">
                                            {benefit.maxAmount && (
                                                <span>${benefit.maxAmount}</span>
                                            )}
                                            <span>•</span>
                ...
                {product.benefits.length > 4 && (
                    ...
                    >
                        ...
                        +{product.benefits.length - 4} more benefit{product.benefits.length - 4 !== 1 ? 's' : ''}
                    </motion.p>
                )}
            </div>
